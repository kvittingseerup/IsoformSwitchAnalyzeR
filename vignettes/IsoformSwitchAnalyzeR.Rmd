...
9. _Petersen et al. **SignalP 4.0: discriminating signal peptides from transmembrane regions**. Nature Methods, 8:785-786, 2011_ [link](https://www.nature.com/articles/nmeth.1701)
...
extractConsequenceEnrichmentComparison(
    ...
    analysisOppositeConsequence = TRUE,
    returnResult = FALSE # returns a data.frame with the results
)
```
