...
<center> _Vitting-Seerup et al. **The Landscape of Isoform Switches in Human Cancers.** Cancer Res. (2017)_ <center>
<br />
...
<p align="left"> If you are using the **visualizations** (plots) implemented in the IsoformSwitchAnalyzeR package please cite: <p>
...
It is noteworthy that _importIsoformExpression()_ also supports import of transcript per million (TxPM). TxPM is of paticular interest since these expression values have been normalized in a manner removing types of biases (that each of the tools support).
...
### Quality control of ORF of known annotation
As we have shown there are quit a lot of problems with known CDS annotation (see supplementary data in Vitting-Seerup et al 2017) we have implemented two ways to ensure a high quality of the CDS imported from a GTF annotation file:
